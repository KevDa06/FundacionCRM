...
// ==================== MOCK CLIENT FALLBACK (AI STUDIO RUNTIME) ====================
// Provee persistencia local y soporte completo de métodos de Supabase en caso de no
// tener credenciales configuradas, permitiendo que la aplicación arranque de inmediato.
...
if (!isSupabaseConfigured) {
  console.info('[Supabase Config] VITE_SUPABASE_URL y/o VITE_SUPABASE_ANON_KEY no configuradas. Activando Mock Store con persistencia local para desarrollo/demo.');
}
